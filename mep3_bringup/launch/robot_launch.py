...
INITIAL_POSE_MATRIX = [
    ('big', 'blue', [0.735, -1.07, pi]), # ((((0.885 (prepravljeno na 0.685), -1.07, pi)))) prepravljeno za 5cm sa 0.685
    ('big', 'yellow', [0.735, 1.07, pi]), # ((((0.885 (prepravljeno na 0.685), 1.07, pi)))) prepravljeno za 5cm sa 0.685
