// Copied from https://github.com/BehaviorTree/BehaviorTree.ROS2/blob/main/include/behaviortree_ros2/bt_action_node.hpp
...
namespace BT
{
    ...
    inline RosActionNode<T>::RosActionNode(const std::string &instance_name,
                                           const BT::NodeConfiguration &conf,
                                           const ActionNodeParams &params,
                                           typename std::shared_ptr<ActionClient> external_action_client) : BT::ActionNodeBase(instance_name, conf),
                                                                                                            node_(params.nh),
    ...
    template <class T>
    inline bool RosActionNode<T>::should_cancel_goal()
    {
