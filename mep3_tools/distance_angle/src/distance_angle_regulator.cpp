#include "distance_angle/distance_angle_regulator.hpp"
#include <iostream>
...
DistanceAngleRegulator::DistanceAngleRegulator() : Node("distance_angle_regulator")
{
    ...
    command_subscription_ = this->create_subscription<distance_angle_interfaces::msg::MotionCommand>("/da_command", 100, std::bind(&DistanceAngleRegulator::command_callback, this, _1));
...
void DistanceAngleRegulator::command_callback(const distance_angle_interfaces::msg::MotionCommand::SharedPtr msg)
{
