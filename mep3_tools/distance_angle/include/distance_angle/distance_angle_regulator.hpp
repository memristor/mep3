...
#include "distance_angle_interfaces/msg/motion_command.hpp"
...
class DistanceAngleRegulator : public rclcpp::Node
{
    ...
    private:
        ...
        void command_callback(const distance_angle_interfaces::msg::MotionCommand::SharedPtr msg);
        rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr odometry_subscription_;
        rclcpp::Subscription<distance_angle_interfaces::msg::MotionCommand>::SharedPtr command_subscription_;
