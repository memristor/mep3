...
namespace mep3_navigation
{
    ...
    OpponentTrackingLayer::OpponentTrackingLayer() : Node("opponent_tracking_layer")
    {
        ...
        this->opponent_pub_ = this->create_publisher<nav_msgs::msg::OccupancyGrid>("opponent_tracking/occupancy", 10);
        this->opponent_updates_pub_ = this->create_publisher<map_msgs::msg::OccupancyGridUpdate>("opponent_tracking/occupancy_updates", 10);
