...
#include "mep3_navigation/plugins/condition/globally_updated_goal_condition.hpp"
...
{
  factory.registerNodeType<mep3_navigation::GloballyUpdatedGoalCondition>("GlobalUpdatedGoal");
}
