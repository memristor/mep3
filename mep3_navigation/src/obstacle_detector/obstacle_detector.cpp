...
public:
  ObstacleDetector() : Node("obstacle_detector") {
    ...
    laser_scan_subscriber_ = this->create_subscription<sensor_msgs::msg::LaserScan>(
      "scan_inflated", 10, std::bind(&ObstacleDetector::laser_scan_callback, this, _1));
    range_fl_subscriber_ = this->create_subscription<sensor_msgs::msg::Range>(
                                                                              "binary_ranger_command/front_left", 10, std::bind(&ObstacleDetector::range_callback_fl, this, _1));
    range_fr_subscriber_ = this->create_subscription<sensor_msgs::msg::Range>(
                                                                              "binary_ranger_command/front_right", 10, std::bind(&ObstacleDetector::range_callback_fr, this, _1));
    range_rl_subscriber_ = this->create_subscription<sensor_msgs::msg::Range>(
                                                                              "binary_ranger_command/rear_left", 10, std::bind(&ObstacleDetector::range_callback_rl, this, _1));
    range_rr_subscriber_ = this->create_subscription<sensor_msgs::msg::Range>(
                                                                              "binary_ranger_command/rear_right", 10, std::bind(&ObstacleDetector::range_callback_rr, this, _1));
